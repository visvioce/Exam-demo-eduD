<template>
  <div class="dashboard">
    ...
    <el-card class="quick-actions-card">
      ...
      <el-row :gutter="12">
        <el-col :xs="12" :sm="6" v-if="hasPermission(['ADMIN', 'TEACHER'])">
...
async function loadStats() {
  ...
  const [courseCount, examCount] = await Promise.all([
    safeCount(() => courseApi.getMyCourses()),
    safeCount(() => examApi.getMyExams())
  ])
  stats.value = { userCount: 0, courseCount, questionCount: 0, examCount }
}
