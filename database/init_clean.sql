-- =====================================================
-- 南方职业学院在线考试系统数据库初始化脚本（纯净版）
-- =====================================================
--
-- 说明：包含完整表结构 + 3个基本用户（管理员、教师、学生）
...
-- 密码统一为：123456（BCrypt加密）
-- 加密串：$2a$10$CtPfaJ07wDeCSUCp6LgigeYEVZxOU4xOcEnaig3CqqKFphhOiiv.G

INSERT INTO users (id, username, password, nickname, role, status, created_at, deleted) VALUES
(1, 'admin', '$2a$10$CtPfaJ07wDeCSUCp6LgigeYEVZxOU4xOcEnaig3CqqKFphhOiiv.G', '系统管理员', 'ADMIN', 'ACTIVE', NOW(), 0),
(2, 'teacher', '$2a$10$CtPfaJ07wDeCSUCp6LgigeYEVZxOU4xOcEnaig3CqqKFphhOiiv.G', '测试教师', 'TEACHER', 'ACTIVE', NOW(), 0),
(3, 'student', '$2a$10$CtPfaJ07wDeCSUCp6LgigeYEVZxOU4xOcEnaig3CqqKFphhOiiv.G', '测试学生', 'STUDENT', 'ACTIVE', NOW(), 0);
